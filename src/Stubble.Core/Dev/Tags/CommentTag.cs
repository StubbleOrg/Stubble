// <copyright file="CommentTag.cs" company="Stubble Authors">
...
namespace Stubble.Core.Dev.Tags
{
    ...
    /// </summary>
    public class CommentTag : InlineTag<CommentTag>
    {
        /// <inheritdoc/>
        public override bool Equals(CommentTag other)
        {
            if (other == null)
            {
                return false;
